        ...
        if (search) {
            searchQuery = {
                $or: [
                    ...
                    // We could also search by player names if needed
                ]
            }
        }
    ...
    for (const player of players) {
        try {
            ...
            if (!leaderboardEntry) {
                ...
                leaderboardEntry.lastGameId = player.gameId;
                
                // Update best/worst games
                if (player.net > leaderboardEntry.bestGame.profit) {
                    leaderboardEntry.bestGame = {
                        profit: player.net,
                        gameId: player.gameId
                    };
                }
                if (player.net < leaderboardEntry.worstGame.profit) {
                    leaderboardEntry.worstGame = {
                        profit: player.net,
                        gameId: player.gameId
                    };
                }
